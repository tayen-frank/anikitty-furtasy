  ...
  return (
    <section className="mx-auto max-w-4xl space-y-8 py-8 text-center">
      <div className="space-y-3">
        <p className="text-sm uppercase tracking-[0.34em] text-fantasy-gold/80">
        ...
        <p className="mx-auto max-w-2xl text-base leading-7 text-fantasy-mist/70">
          The portrait is being shaped with your chosen fantasy essence. Stay close. The final reveal
          is almost ready.
        </p>
      </div>
      ...
      <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.28)] sm:p-8">
        ...
        <div className="mt-8 flex flex-col items-center justify-center">
          ...
          <p className="text-xs uppercase tracking-[0.34em] text-fantasy-mist/45">Arcane Whisper</p>
          <div className="relative mt-4 min-h-[3.5rem] w-full max-w-2xl px-4">
            <p
              className={cn(
                ...
                isPhraseVisible ? "translate-y-0 opacity-100" : "translate-y-1 opacity-0",
      ...
      <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
        ...
        {status === "done" ? (
          ...
          <p className="rounded-full border border-fantasy-gold/20 bg-white/[0.05] px-5 py-3 text-sm text-fantasy-mist/75">
            The reveal will appear automatically when the portrait is ready.
          </p>
        )}
      </div>
    </section>
